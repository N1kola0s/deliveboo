        ...
        <div class="col">
            <div class="bg-white p-3 h-100">
                ...
                <div class="mb-4">
                    ...
                    <input onkeypress="return (event.charCode >= 60 || event.charCode == 8 || event.charCode == 32)" type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Scrivi nome piatto" aria-describedby="nameHelper" value="{{old('name')}}" maxlength="50" minlength="3" pattern="[A-Z a-z]{0,50}" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" step="0.01" name="price" id="price" class="form-control @error('price') is-invalid @enderror" placeholder="Scrivi il prezzo" aria-describedby="priceHelper" value="{{old('price')}}" required>
